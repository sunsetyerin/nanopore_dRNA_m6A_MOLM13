...
data["test"]["rep1"] = str(Path("results/xpore/xpore_dataprep/test_0/data.json").resolve().parent)
data["test"]["rep2"] = str(Path("results/xpore/xpore_dataprep/test_1/data.json").resolve().parent)
